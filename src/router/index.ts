...
import Technique from "../view/logistic/Technique.vue";
import Drobilka from "../view/logistic/Drobilka.vue";
import RecieveIncomeProduct from "../view/logistic/RecieveIncomeProduct.vue";
import DailyCost from "../view/chsm/DailyCost.vue";
import ReadyProduct from "@/view/produce/ReadyProduct.vue";
import ProduceCost from "@/view/produce/ProduceCost.vue";
import ProduceRemainder from "@/view/produce/ProduceRemainder.vue";
import LBPurchase from "@/view/lb/LBPurchase.vue";
import Mixer from "@/view/lb/Mixer.vue";
import LBPrice from "@/view/lb/LBPrice.vue";
import Ingredient from "@/view/lb/Ingredient.vue";
import LBRemainder from "@/view/lb/LBRemainder.vue";
import LBPurchaseList from "@/view/lb/LBPurchaseList.vue";
import Warehouse from "@/view/general/Warehouse.vue";
import IncomeGeneralItem from "@/view/general/IncomeGeneralItem.vue";
import SpendGeneralItem from "@/view/general/SpendGeneralItem.vue";
import ChsmPurchaseList from "@/view/chsm/ChsmPurchaseList.vue";
import Order from "@/view/chsm/Order.vue";
import Price from "@/view/chsm/Price.vue";
import NasosService from "@/view/nasos/NasosService.vue";
import NasosCost from "@/view/nasos/NasosCost.vue";
import Remainder from "@/view/chsm/Remainder.vue";
import Login from "@/view/Login.vue";
import SimilarInformation from "@/view/settings/SimilarInformation.vue";
import Employee from "@/view/wage/Employee.vue";
import Dismissal from "@/view/wage/Dismissal.vue";
import Tabel from "@/view/wage/Tabel.vue";
import Users from "@/view/settings/Users.vue";
import Permission from "@/view/settings/Permission.vue";
import CHSMPurchase from "@/view/chsm/CHSMPurchase.vue";
import Estinguish from "@/view/chsm/Estinguish.vue";
import Kassa from "@/view/chsm/Kassa.vue";
import ProfileSettings from "@/components/Social/ProfileSettings/ProfileSettings.vue";
import Home from "@/view/Home.vue";
import LeaderBetonDashboard from "@/view/dashboard/LeaderBetonDashboard.vue";
import LogisticDashboard from "@/view/dashboard/LogisticDashboard.vue";
import ProduceDashboard from "@/view/dashboard/ProduceDashboard.vue";
import NasosDashboard from "@/view/dashboard/NasosDashboard.vue";
import WarehouseDashboard from "@/view/dashboard/WarehouseDashboard.vue";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'warehouse-dashboard', name: 'WarehouseDashboard', component: WarehouseDashboard },
      { path: 'nasos-dashboard', name: 'NasosDashboard', component: NasosDashboard },
      //CHSM
      { path: 'chsm-purchase', name: 'ChsmPurchaseList', component: ChsmPurchaseList },
      { path: 'order', name: 'Order', component: Order },
      { path: 'kassa', name: 'Kassa', component: Kassa },
      { path: 'chsm-purchase-save', name: 'CHSMPurchase', component: CHSMPurchase },
      { path: 'chsm-estinguish', name: 'Estinguish', component: Estinguish },
      { path: 'price', name: 'Price', component: Price },
      { path: 'remainder', name: 'Remainder', component: Remainder },
        //Logistic
      { path: 'technique', name: 'Technique', component: Technique },
      { path: 'daily-cost', name: 'DailyCost', component: DailyCost },
      { path: 'drobilka', name: 'Drobilka', component: Drobilka },
      { path: 'ready-product', name: 'ReadyProduct', component: ReadyProduct },
      { path: 'produce-cost', name: 'ProduceCost', component: ProduceCost },
      { path: 'produce-remainder', name: 'ProduceRemainder', component: ProduceRemainder },
      { path: 'recieve-income-product', name: 'RecieveIncomeProduct', component: RecieveIncomeProduct },
      //LB
      { path: 'lb-purchase', name: 'LBPurchase', component: LBPurchase },
      { path: 'lb-purchase-list', name: 'LBPurchaseList', component: LBPurchaseList },
      { path: 'mixer', name: 'Mixer', component: Mixer },
      { path: 'ingredient', name: 'Ingredient', component: Ingredient },
      { path: 'lb-remainder', name: 'LBRemainder', component: LBRemainder },
      { path: 'lb-price', name: 'LBPrice', component: LBPrice },
      //Nasos
      { path: 'nasos-service', name: 'NasosService', component: NasosService },
      { path: 'nasos-cost', name: 'NasosCost', component: NasosCost },
      // { path: 'income-warehouse', name: 'IncomeGeneralItem', component: IncomeGeneralItem },
      // { path: 'spend-warehouse', name: 'SpendGeneralItem', component: SpendGeneralItem },
      ...
      //Settings
      { path: 'similar-information', name: 'SimilarInformation', component: SimilarInformation },
      { path: 'users', name: 'Users', component: Users },
      { path: 'permission', name: 'Permission', component: Permission },
      { path: 'users-list', name: 'UsersListPage', component: UsersListPage },
      { path: 'profile-settings', name: 'ProfileSettingsPage', component: ProfileSettings },
      { path: 'profile-settings/:id', name: 'ProfileSettings', component: ProfileSettings },
...
export function isTokenExpired() {
  ...
  const expiryToken = getExpiry();
  if (!expiryToken) return true;
  // const payload = JSON.parse(atob(token.split('.')[1]));
  const expiry = parseInt(expiryToken);

<template>
    ...
    >
      <div class="d-sm-flex align-items-center">
        <button
            ...
            data-bs-target="#createNewTechniqueModal"
        >
          Texnika qo'shish
        ...
        <table class="table text-nowrap align-middle mb-0">
          ...
          <tr v-for="(t,index) in paginatedData" :id="index" v-bind:key="index">
            ...
            <td class="shadow-none lh-1 fw-medium text-black-emphasis">
              {{ t.techniqueType.name.activeLanguage }}
            </td>
            <td class="shadow-none lh-1 fw-medium text-black-emphasis">
              {{ t.autoNumber }}
            </td>
            <td class="shadow-none lh-1 fw-medium text-black-emphasis">
              {{ t.perKmCostAmount }} SO'M
            </td>
            <td class="shadow-none lh-1 fw-medium text-black-emphasis">
            ...
            >
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item d-flex align-items-center cursor-pointer" @click="edit(t.id)"
                       data-bs-toggle="modal"
                       data-bs-target="#createNewTechniqueModal">
  ...
  <CreateTechniqueModal :editId="editId"/>
</template>

<script>
import CreateTechniqueModal from "@/view/logistic/modal/CreateTechniqueModal";
...
export default {
  ...
  name: "Technique",
  components: {PaginationCustom, CreateTechniqueModal},
  data() {
    return {
      techniques: [],
      editId: 0,
    ...
    deleteRow(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.get("technician/delete/" + id).then(res => {

            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="form-group mb-15 mb-md-25">
                  ...
                  <select class="form-select fs-md-15 text-black shadow-none" not_empty='true' v-model="cost.sexEnum">
...
export default {
  ...
  methods: {
    ...
    getCostTypes() {
      this.$http.get("references/def/produce_cost" + localStorage.getItem('lang')).then(res => {
